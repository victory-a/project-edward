              ...
              <main className="pa4 black-80" >
                  <div className="measure">
                      <fieldset id="sign_up" className="ba b--transparent ph0 mh0" >
                          <legend className="center f2 fw4 ph0 mh0">Register</legend>
                          <div className="mt3">
                      ...
                      <div className="">
                          <input className="ph3 pv2 input-reset ba b--blue bg-transparent grow pointer f6 dib" type="submit"value="Register" />
                      </div>
